...
(function() {
    angular.module('ionic.rating', []).constant('ratingConfig', {
        ...
        return {
            ...
            template: '<ul class="rating" ng-mouseleave="reset()" ng-keydown="onKeydown($event)">' + '<li class="rating-list-item" ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon" ng-class="$index < value && (r.stateOn || \'ion-ios7-star\') || (r.stateOff || \'ion-ios7-star-outline\')"></i></li>' + '</ul>',
            replace: true,
