(function (ionic) {
    ...
    var length = transformKeys.length;
    ...
    var length = transitionKeys.length;
    for (var i = 0; i < length; i++) {
    ...
    var SwipeableCardView = ionic.views.View.inherit({
         ...
         */
        setX: function (x) {
            this.el.style[ionic.CSS.TRANSFORM] = 'translateX(' + x + 'px)';
            this.x = x;
            this.startX = x;
        },
         ...
         */
        setY: function (y) {
            this.el.style[ionic.CSS.TRANSFORM] = 'translateX(' + this.x + 'px)';
            this.y = y;
            this.startY = y;
        },
        ...
        transitionOut: function () {
            ...
            if (this.y < 0) {
                ...
                var direction = this.startX < this.x ? 1 : -1;
                //this.el.style[ionic.CSS.TRANSFORM] = 'translate3d(' + this.x + ',' + (window.innerHeight * 1.5) + 'px, 0) rotate(' + rotateTo + 'rad)';
                this.el.style[ionic.CSS.TRANSFORM] = 'translateX(' + (direction * window.innerWidth * 1.5) + 'px)';
        ...
        _doDrag: function (e) {
            ...
            if (e.gesture.deltaX > 200 || e.gesture.deltaX < -200) {
        ...
        _doDragEnd: function (e) {
            ...
            if (this.itemRemoved) {
                ...
                setTimeout(function () {
                    //self.onDestroy && self.onDestroy();
                    //self.el.style[ionic.CSS.TRANSFORM] = '-webkit-transform 0.2s ease-in-out';
                    self.el.style[TRANSITION] = 'max-height 0.3s ease-out';
                    self.el.style['max-height'] = '0';
                    self.el.style['margin-top'] = '0';

                }, 200);
            }
            else {
                this.el.style[TRANSITION] = '-webkit-transform 0.2s ease-in-out';
                this.el.style[ionic.CSS.TRANSFORM] = 'translateX(' + this.startX + 'px)';
